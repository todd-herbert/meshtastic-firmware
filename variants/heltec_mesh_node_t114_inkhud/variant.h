 ...
 * E-Ink DIY
 */
#define PIN_EINK_CS (32 + 15)
#define PIN_EINK_BUSY (32 + 13)
#define PIN_EINK_DC (0 + 5)
#define PIN_EINK_RES (0 + 7)
#define PIN_EINK_SCLK (32 + 14)
#define PIN_EINK_MOSI (32 + 12) // also called SDI
