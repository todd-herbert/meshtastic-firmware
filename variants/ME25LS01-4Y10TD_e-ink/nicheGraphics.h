...
#warning Display resilience has not yet been determined
    ...
    */
    ...
    inkhud->addApplet("All Messages", new InkHUD::AllMessageApplet);                      // Inactive
    ...
    // Setup the main (0) user button
    buttons->setWiring(0, BUTTON_PIN, LOW, INPUT_PULLUP);
    ...
    // Setup an aux (1) button
    // Bonus feature of your choice, if your board has a spare button
    /*
        buttons->setWiring(1, PIN_AUX_BUTTON);
